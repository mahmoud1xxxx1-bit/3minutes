...
class Puzzle13 extends PuzzleDefinition {
  ...
  List<Difference> get differences => [
    ...
    Difference(
      'chalkEquation',
      const Rect.fromLTWH(235.0, 120.0, 40, 40),
      const Offset(255, 140),
      (HtmlCanvas c) {
        
        c.fillStyle = '#222'; c.fillRect(230, 125, 50, 30); 
        c.fillStyle = 'rgba(255,255,255,0.7)'; c.font = '24px monospace'; c.fillText('SO2', 230, 150);
