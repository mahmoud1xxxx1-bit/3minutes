...
class _OnetConnectGameState extends State<OnetConnectGame> with SingleTickerProviderStateMixin {
  ...
  void _onPanUpdate(DragUpdateDetails d, double tileWidth, double tileHeight) {
    ...
    setState(() {
      ...
      while (_draggedTile != null && _dragDeltaPx.dx > tileWidth * 0.6) {
        _tryMove(t, 0, 1, tileWidth, tileHeight);
      }
      while (_draggedTile != null && _dragDeltaPx.dx < -tileWidth * 0.6) {
        _tryMove(t, 0, -1, tileWidth, tileHeight);
      }
      while (_draggedTile != null && _dragDeltaPx.dy > tileHeight * 0.6) {
        _tryMove(t, 1, 0, tileWidth, tileHeight);
      }
      while (_draggedTile != null && _dragDeltaPx.dy < -tileHeight * 0.6) {
        _tryMove(t, -1, 0, tileWidth, tileHeight);
      }
      ...
      bool canGoRight = t.c < _cols && (_grid[t.r][t.c + 1] == null || _grid[t.r][t.c + 1]!.animal == t.animal);
      bool canGoLeft = t.c > 1 && (_grid[t.r][t.c - 1] == null || _grid[t.r][t.c - 1]!.animal == t.animal);
      bool canGoDown = t.r < _rows && (_grid[t.r + 1][t.c] == null || _grid[t.r + 1][t.c]!.animal == t.animal);
      bool canGoUp = t.r > 1 && (_grid[t.r - 1][t.c] == null || _grid[t.r - 1][t.c]!.animal == t.animal);
  ...
  void _tryMove(TileModel t, int dr, int dc, double tileWidth, double tileHeight) {
    int nextR = t.r + dr;
    int nextC = t.c + dc;
    ...
    if (nextR < 1 || nextR > _rows || nextC < 1 || nextC > _cols) {
      ...
      } else if (nextTile.animal == t.animal) {
        _grid[t.r][t.c] = null;
        _grid[nextR][nextC] = null;
        t.isMatched = true;
    ...
    if (hitObstacle) {
      if (dc != 0) _dragDeltaPx = Offset(0, _dragDeltaPx.dy);
      if (dr != 0) _dragDeltaPx = Offset(_dragDeltaPx.dx, 0);
    }
  }
