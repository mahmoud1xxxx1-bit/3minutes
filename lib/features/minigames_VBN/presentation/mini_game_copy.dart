...
class MiniGameCopy {
  ...
  String title(String gameId) => switch (gameId) {
        ...
        'mirror_control' => isArabic ? 'تحكم المرآة' : 'Mirror Control',
  ...
  String get mirrorControlInstruction => isArabic
      ? 'اجمع النجوم بالدائرة'
      : 'Collect stars with the circle';
  String get trafficLoopInstruction => isArabic
      ? 'ادمج سياراتك في المسار الدائري وتجنب الحوادث'
      : 'Merge your cars into the loop and avoid crashes';
  String get trafficLoopCars => isArabic ? 'السيارات' : 'Cars';
