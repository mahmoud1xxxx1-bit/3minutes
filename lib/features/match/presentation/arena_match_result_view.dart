  ...
  Future<void> _finalize() async {
    ...
    try {
      ...
      if (backend is RankedSettlementResultBackend && widget.match.isRanked) {
        final receipt = await backend.finalizeMatchWithResult(
          ...
          child: ArenaCard(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  l10n.historyOpponentResult(opponent.completedGames, match.gameCount, opponent.totalScore),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _ScoreBoard(
            myScore: mine.totalScore,
            opponentScore: opponent.totalScore,
            myGames: mine.completedGames,
            opponentGames: opponent.completedGames,
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: const TextStyle(color: GameColors.textSoft, fontWeight: FontWeight.w800),
                    ),
                  ),
                ],
              ),
          ...
          const SizedBox(height: GameSpacing.lg),
          ArenaPlayButton(
            title: copy.rematchNow,
            subtitle: copy.isArabic ? 'نفس الخصم • مواجهة جديدة • فرصة للرد' : 'Same rival • fresh battle • settle the score',
          ...
          ArenaPlayButton(
            title: copy.home,
            subtitle: copy.isArabic ? 'العودة للساحة ومراجعة تقدمك' : 'Return to the arena and review your progress',
    ...
    return Column(
      children: [
          ...
          FutureBuilder<CosmeticLoadout>(
            ...
            builder: (context, snapshot) {
              ...
              if (loadout.victoryEffectId != null) {
                return CosmeticVictoryEffect(effectId: loadout.victoryEffectId!, winnerName: name, height: 190);
              }
              return _ResultEmblem(color: color);
            },
          )
        else
        ...
        Text(
          title,
          textAlign: TextAlign.center,
          style: Theme.of(context).textTheme.displaySmall?.copyWith(color: color, fontWeight: FontWeight.w900, letterSpacing: .8),
        ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: color.withValues(alpha: .18), blurRadius: 38)],
      ),
...
class _RewardBoard extends StatelessWidget {
            ...
            Row(
              children: [
                ...
                if (ranked) ...[
                  ...
                  ArenaMetric(
                    label: 'RP',
                    value: '${receipt.rpDelta >= 0 ? '+' : ''}${receipt.rpDelta}',
                    icon: receipt.rpDelta >= 0 ? Icons.trending_up_rounded : Icons.trending_down_rounded,
                    color: receipt.rpDelta >= 0 ? GameColors.success : GameColors.danger,
                  ),
                ],
              ],
            )
  ...
  double _rankDeltaProgress(RankedSettlementPlayer receipt) {
    final delta = receipt.rpDelta.abs().clamp(0, 120);
    return (delta / 120).clamp(0.05, 1.0);
  }
}
