...
class MasterPigeonPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    // Use a prime multiplier coprime with 90 to create a pseudo-random order 
    // that visits all 90 completely unique themes without repeating!
    int globalIndex = (seed * 17) % 90;
