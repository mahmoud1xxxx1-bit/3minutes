  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 30; i++) {
      ...
      canvas.drawCircle(
        ...
        r, 
        Paint()
          ..color = Color.fromARGB(255, rnd.nextInt(255), 100, rnd.nextInt(255)).withValues(alpha: 0.4)
    ...
    for(int i = 0; i < 20; i++) {
      ...
      canvas.drawCircle(Offset(bx, by), 2 + rnd.nextDouble()*4, Paint()..color=Colors.white.withValues(alpha: 0.3)..style=PaintingStyle.stroke);
    }
    ...
    if (engine.exitGate != null) {
        ...
        canvas.drawCircle(engine.exitGate!, 45 + pulse, Paint()..color=Colors.lightBlueAccent.withValues(alpha: 0.5)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
