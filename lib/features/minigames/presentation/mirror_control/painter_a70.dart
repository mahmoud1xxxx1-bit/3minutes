...
class GamePainterA70 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      rayPath.close();
      canvas.drawPath(rayPath, Paint()..color = Colors.lightBlueAccent.withOpacity(0.05)..blendMode = BlendMode.screen);
    }
    ...
    for (int i = 0; i < 150; i++) {
      ...
      canvas.drawCircle(Offset(px, py), rnd.nextDouble() * 4 + 1, Paint()..color = Colors.white.withOpacity(0.3)..style = PaintingStyle.stroke);
    }
