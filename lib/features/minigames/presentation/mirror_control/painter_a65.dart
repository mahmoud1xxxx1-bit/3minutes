...
class GamePainterA65 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 8; i++) {
        ...
        canvas.drawCircle(Offset.zero, r, Paint()..color=Colors.brown[700]!.withOpacity(0.4)..style=PaintingStyle.stroke..strokeWidth=15);
        for (int j = 0; j < 8; j++) {
            canvas.rotate(math.pi / 4);
            canvas.drawLine(Offset.zero, Offset(r, 0), Paint()..color=Colors.brown[700]!.withOpacity(0.4)..strokeWidth=10);
            canvas.drawRect(Rect.fromCenter(center: Offset(r+5, 0), width: 10, height: 15), Paint()..color=Colors.brown[700]!.withOpacity(0.4));
        }
