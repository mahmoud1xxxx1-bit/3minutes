...
class GamePainterA74 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 20; i++) {
      ...
      canvas.drawCircle(Offset(px, py), 40, Paint()..color = Colors.white.withOpacity(0.4)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
      canvas.drawCircle(Offset(px+30, py-10), 30, Paint()..color = Colors.white.withOpacity(0.4)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
    }
