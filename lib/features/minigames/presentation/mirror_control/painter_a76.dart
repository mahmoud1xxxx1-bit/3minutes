...
// deleted
    ...
    final glassPaint = Paint()..color = Colors.purple.shade800.withValues(alpha: 0.5)..style = PaintingStyle.stroke..strokeWidth = 3;
    for(double x=0; x<GameEngine.fieldSize; x+=100) {
      for(double y=0; y<GameEngine.fieldSize; y+=100) {
        ...
        canvas.drawCircle(Offset(x+50, y+50), 30, Paint()..color=Colors.purpleAccent.withValues(alpha: 0.2));
      }
    }
