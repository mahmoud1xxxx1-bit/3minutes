...
class GamePainterA90 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i=0; i<40; i++) {
        ...
        canvas.drawCircle(Offset(rX, rY), rnd.nextDouble() * 20 + 10, Paint()..color = const Color(0xFF556B2F).withOpacity(0.6)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
    }
    ...
    if (engine.exitGate != null) {
        ...
        canvas.drawCircle(engine.exitGate!, 45, Paint()..color=const Color(0xFFDDDD00).withOpacity(0.5)..style=PaintingStyle.stroke..strokeWidth=15..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
