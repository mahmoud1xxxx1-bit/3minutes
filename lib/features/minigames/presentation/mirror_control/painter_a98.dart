...
class GamePainterA98 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i=0; i<100; i++) {
        ...
        canvas.drawCircle(Offset(x, y), rnd.nextDouble() * 2, Paint()..color=Colors.white.withValues(alpha: 0.5));
    }
    ...
    for (int i=0; i<5; i++) {
        ...
        canvas.drawPath(path, Paint()..color=Colors.cyanAccent.withValues(alpha: 0.3)..style=PaintingStyle.stroke..strokeWidth=1);
    }
    ...
    for (int i = 0; i < engine.obstacles.length; i++) {
        ...
        canvas.drawRect(obs.deflate(5), Paint()..color=Colors.blueGrey.withValues(alpha: 0.5)..style=PaintingStyle.stroke);
    }
