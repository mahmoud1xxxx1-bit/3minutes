  ...
  void paint(Canvas canvas, Size size) {
    ...
    for(int i=0; i<15; i++) {
        canvas.drawCircle(Offset(rnd.nextDouble()*GameEngine.fieldSize, rnd.nextDouble()*GameEngine.fieldSize), 
                          10 + rnd.nextDouble()*40, Paint()..color=const Color(0xFF1E1E1E).withOpacity(0.1));
    }
    
    for(int i=0; i<30; i++) {
        double y = rnd.nextDouble()*GameEngine.fieldSize;
        double x = rnd.nextDouble()*GameEngine.fieldSize;
        canvas.drawLine(Offset(x, y), Offset(x + 50 + rnd.nextDouble()*100, y), Paint()..color=const Color(0xFF1E1E1E).withOpacity(0.2)..strokeWidth=1);
    }
