...
class GamePainterA87 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i=0; i<50; i++) {
        ...
        canvas.drawCircle(Offset(rX, rY), rS, Paint()..color = const Color(0xFF1E3A24).withValues(alpha: 0.6)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
    }
    ...
    for (int i=0; i<10; i++) {
        ...
        canvas.drawCircle(Offset(mx, my), 100, Paint()..color=Colors.white.withValues(alpha: 0.05)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
    }
    ...
    if (engine.exitGate != null) {
        ...
        canvas.drawCircle(engine.exitGate!, 40, Paint()..color=const Color(0xFF00FF88).withValues(alpha: 0.3)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
    }
