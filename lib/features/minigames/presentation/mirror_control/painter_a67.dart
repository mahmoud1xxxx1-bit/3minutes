...
class GamePainterA67 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double i = 0; i < GameEngine.fieldSize; i+=40) {
        canvas.drawLine(Offset(i, 0), Offset(i, GameEngine.fieldSize), Paint()..color=Colors.cyanAccent.withOpacity(0.1)..strokeWidth=1);
        canvas.drawLine(Offset(0, i), Offset(GameEngine.fieldSize, i), Paint()..color=Colors.cyanAccent.withOpacity(0.1)..strokeWidth=1);
    }
    ...
    for (int i = 0; i < 100; i++) {
        ...
        canvas.drawLine(Offset(x, y), Offset(x - 5, y + 15), Paint()..color=Colors.cyanAccent.withOpacity(0.5)..strokeWidth=2);
    }
    ...
    for (int i = 0; i < engine.obstacles.length; i++) {
        ...
        canvas.drawRect(obs, Paint()..color=neon.withOpacity(0.8)..style=PaintingStyle.stroke..strokeWidth=2..maskFilter=const MaskFilter.blur(BlurStyle.normal, 5));
