...
class GamePainterA105 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final gearPaint = Paint()..color=const Color(0xFFF0E68C).withOpacity(0.5)..style=PaintingStyle.stroke..strokeWidth=8;
    for(int i=0; i<3; i++) {
        ...
        for(int j=0; j<12; j++) {
            ...
            canvas.drawRect(const Rect.fromLTWH(140, -10, 30, 20), Paint()..color=const Color(0xFFF0E68C).withOpacity(0.5));
        }
        canvas.restore();
    }
    
    // Chronal energy waves
    final wavePaint = Paint()..color=Colors.amberAccent.withOpacity(0.3)..style=PaintingStyle.stroke..strokeWidth=3;
    ...
    for (int i = 0; i < engine.obstacles.length; i++) {
        ...
        canvas.drawRect(obs.deflate(4), Paint()..color=Colors.white.withOpacity(0.8)); // Glass
