...
class GamePainterA71 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 100; i++) {
      ...
      canvas.drawCircle(Offset(px, py), 4, Paint()..color = Colors.greenAccent.withOpacity(glow)..maskFilter = const MaskFilter.blur(BlurStyle.normal, 3));
    ...
    for (int i = 0; i < engine.targets.length; i++) {
        ...
        if (isActive) {
            ...
            canvas.drawCircle(target, 35*p, Paint()..color=Colors.purpleAccent.withOpacity(0.6)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
