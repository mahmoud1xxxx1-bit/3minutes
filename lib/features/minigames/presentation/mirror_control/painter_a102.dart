  ...
  void paint(Canvas canvas, Size size) {
    ...
    for(int i=0; i<30; i++) {
        ...
        final swirlPaint = Paint()
            ..color = HSVColor.fromAHSV(1.0, (angle * 40) % 360, 1.0, 1.0 - (r/1000)).toColor().withValues(alpha: 0.4)
    ...
    final rayPaint = Paint()..color = Colors.white.withValues(alpha: 0.3)..style = PaintingStyle.stroke;
    for(int i=0; i<20; i++) {
    ...
    for (int i = 0; i < engine.obstacles.length; i++) {
        ...
        canvas.drawRect(obs.inflate(5), Paint()..color=const Color(0xFF9400D3).withValues(alpha: 0.5)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3)); 
        ...
        canvas.drawRect(obs.deflate(2), Paint()..color=Colors.white.withValues(alpha: 0.2)..style=PaintingStyle.stroke..strokeWidth=1);
    }
    ...
    for (int i = 0; i < engine.targets.length; i++) {
        ...
        for (int j=0; j<3; j++) {
            canvas.drawCircle(target, 15 - j*4.0, Paint()..color=HSVColor.fromAHSV(1.0, (engine.time*100 + j*50)%360, 1.0, 1.0).toColor().withValues(alpha: 0.8)..style=PaintingStyle.stroke..strokeWidth=2);
        }
    ...
    if (engine.exitGate != null) {
        ...
        canvas.drawCircle(engine.exitGate!, r, Paint()..color=Colors.cyanAccent.withValues(alpha: 0.8)..style=PaintingStyle.stroke..strokeWidth=8..maskFilter=const MaskFilter.blur(BlurStyle.normal, 5));
        canvas.drawCircle(engine.exitGate!, r-10, Paint()..color=Colors.purpleAccent.withValues(alpha: 0.8)..style=PaintingStyle.stroke..strokeWidth=4);
    }
