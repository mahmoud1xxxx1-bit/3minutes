...
class GamePainterA30Void extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final gridPaint = Paint()..color = const Color(0xFF8A2BE2).withOpacity(0.3)..style = PaintingStyle.stroke..strokeWidth = 1.0;
