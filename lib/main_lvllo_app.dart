...
Future<void> main() async {
  ...
  // HARD RULE: nothing that talks to a platform plugin may start before
  // Flutter has had a chance to render its first frame.
              ...
              child: CosmicPanel(
                ...
                child: LayoutBuilder(
                  builder: (_, c) {
                    ...
                    if (compact) {
                      return Column(
                        children: [brand, const SizedBox(height: 28), action],
                      );
                    }
                    return Row(
                      children: [
