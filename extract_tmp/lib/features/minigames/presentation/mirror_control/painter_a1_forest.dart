...
class GamePainterA1Forest extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // RADAR / GRID
    final radarLinePaint = Paint()..color = const Color(0xFF00FF88).withOpacity(0.04)..style=PaintingStyle.stroke..strokeWidth=2;
    canvas.save();
    ...
    final sweepPaint = Paint()..shader = ui.Gradient.sweep(Offset.zero, [const Color(0xFF00FF88).withOpacity(0.15), const Color(0xFF00FF88).withOpacity(0.0)], [0.0, 0.2]);
    canvas.drawArc(Rect.fromCircle(center: Offset.zero, radius: 1000), 0, math.pi/2, true, sweepPaint);
    canvas.restore();

    
    // Falling Neon Leaves
    final leafPaint = Paint()..color = const Color(0xFF00FF88).withOpacity(0.6);
    for (int i = 0; i < 40; i++) {
    ...
    final blockLaserPaint = Paint()..color = Colors.greenAccent.withOpacity(0.6)..strokeWidth = 2..maskFilter = const MaskFilter.blur(BlurStyle.normal, 3);
    final blockGlassPaint = Paint()..color = Colors.white.withOpacity(0.2);
    final neonBorderPaint = Paint()..color = const Color(0xFF00FF88).withOpacity(0.8)..style = PaintingStyle.stroke..strokeWidth = 2..maskFilter = const MaskFilter.blur(BlurStyle.solid, 3);
    ...
    // TARGET PAINTS
    final targetPulsePaint = Paint()..color = const Color(0xFF00FF88).withOpacity(0.4)..maskFilter = const MaskFilter.blur(BlurStyle.normal, 3);
    ...
    if (engine.exitGate != null) {
      ...
      canvas.drawCircle(Offset.zero, 40 * pulse, Paint()..color = const Color(0xFF00FF88).withOpacity(0.5)..maskFilter = const MaskFilter.blur(BlurStyle.normal, 3));
