  ...
  List<Difference> get differences => [
    ...
    Difference(
      ...
      (HtmlCanvas c) {
        ...
        // تغيير وقت الساعة (تحريك العقارب بشكل طفيف)
        c.fillStyle='#fff'; c.beginPath(); c.arc(710,120,35,0,math.pi*2); c.fill();
        c.strokeStyle='#333'; c.lineWidth = 5; c.stroke();
    ...
    Difference(
      ...
      (HtmlCanvas c) {
        ...
        // مسح المقبض الأسود الصغير فوق غطاء القدر
    ...
    Difference(
      ...
      (HtmlCanvas c) {
        ...
        // إضافة عين موقد (شعلة) ثالثة صغيرة في المنتصف
    ...
    Difference(
      ...
      (HtmlCanvas c) {
        ...
        // تغيير لون مقبض الخزانة العلوية اليمنى إلى الأسود بدلاً من الرمادي
