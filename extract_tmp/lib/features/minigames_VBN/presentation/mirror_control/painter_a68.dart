...
class GamePainterA68 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 6; i++) {
        ...
        canvas.drawCircle(Offset(tx, ty), 60, Paint()..color=Colors.orange.withOpacity(0.15)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
        ...
        canvas.drawPath(flame, Paint()..color=Colors.yellow.withOpacity(0.8));
    }
