...
class GamePainterA3Heist extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // RADAR / GRID
    final radarLinePaint = Paint()..color = const Color(0xFFFFD700).withOpacity(0.04)..style=PaintingStyle.stroke..strokeWidth=2;
    canvas.save();
    ...
    final sweepPaint = Paint()..shader = ui.Gradient.sweep(Offset.zero, [const Color(0xFFFFD700).withOpacity(0.15), const Color(0xFFFFD700).withOpacity(0.0)], [0.0, 0.2]);
    ...
    final laserFloorBg = Paint()..color=Colors.redAccent.withOpacity(0.3)..strokeWidth=4..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3);
    final laserFloorFg = Paint()..color=Colors.white.withOpacity(0.5)..strokeWidth=1;
    ...
    final blockLaserPaint = Paint()..color = Colors.amberAccent.withOpacity(0.6)..strokeWidth = 2..maskFilter = const MaskFilter.blur(BlurStyle.normal, 3);
    final blockGlassPaint = Paint()..color = Colors.white.withOpacity(0.2);
    final neonBorderPaint = Paint()..color = const Color(0xFFFFD700).withOpacity(0.8)..style = PaintingStyle.stroke..strokeWidth = 2..maskFilter = const MaskFilter.blur(BlurStyle.solid, 3);
    ...
    // TARGET PAINTS
    final targetPulsePaint = Paint()..color = const Color(0xFFFFD700).withOpacity(0.4)..maskFilter = const MaskFilter.blur(BlurStyle.normal, 3);
    ...
    if (engine.exitGate != null) {
      ...
      canvas.drawCircle(Offset.zero, 40 * pulse, Paint()..color = const Color(0xFFFFD700).withOpacity(0.5)..maskFilter = const MaskFilter.blur(BlurStyle.normal, 3));
