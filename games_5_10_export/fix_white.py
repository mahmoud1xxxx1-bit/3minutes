...
class _PathLinePainter extends CustomPainter {
  ...
  @override
  void paint(Canvas canvas, Size size) {
    Paint outer = Paint()..color = Colors.orange..style = PaintingStyle.stroke..strokeWidth = 16..strokeCap = StrokeCap.round..strokeJoin = StrokeJoin.round;
    Paint inner = Paint()..color = Colors.yellowAccent..style = PaintingStyle.stroke..strokeWidth = 8..strokeCap = StrokeCap.round..strokeJoin = StrokeJoin.round;
