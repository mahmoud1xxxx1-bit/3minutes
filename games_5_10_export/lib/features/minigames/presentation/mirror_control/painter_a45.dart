...
class GamePainterA45 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final dust = Paint()..color=const Color(0xFFA0522D).withOpacity(0.3)..style=PaintingStyle.stroke..strokeWidth=2;
    ...
    for (int i = 0; i < 5; i++) {
      ...
      canvas.drawCircle(Offset.zero, 20, Paint()..color=const Color(0xFF8B4513).withOpacity(0.5)..style=PaintingStyle.stroke..strokeWidth=2);
      canvas.drawCircle(Offset.zero, 15, Paint()..color=const Color(0xFFA0522D).withOpacity(0.5)..style=PaintingStyle.stroke..strokeWidth=2);
    ...
    for (int i = 0; i < engine.targets.length; i++) {
      ...
      if (isNext) {
          ...
          canvas.restore();
          canvas.drawCircle(Offset.zero, tr*2, Paint()..shader = ui.Gradient.radial(Offset.zero, tr*2, [Colors.white.withOpacity(0.5), Colors.transparent]));
      } else {
          // Rusty spur
