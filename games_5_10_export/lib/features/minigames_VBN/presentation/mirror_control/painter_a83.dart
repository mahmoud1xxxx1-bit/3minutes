...
class GamePainterA83 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 200; i++) {
      ...
      canvas.drawCircle(Offset(px, py), pr, Paint()..color = Colors.tealAccent.withOpacity(opacity)..maskFilter = const MaskFilter.blur(BlurStyle.normal, 2));
    }
    ...
    for (int i = 0; i < engine.obstacles.length; i++) {
        ...
        // Algae patches
        final algaePaint = Paint()..color = Colors.teal.withOpacity(0.6)..maskFilter = const MaskFilter.blur(BlurStyle.normal, 5);
