...
class GamePainterA61 extends CustomPainter {
  GamePainterA61({required this.engine, this.images});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < engine.obstacles.length; i++) {
        ...
        canvas.drawRect(obs, Paint()..color=const Color(0xFF1F1F33));
        canvas.drawRect(obs, Paint()..color=const Color(0xFFFF0055)..style=PaintingStyle.stroke..strokeWidth=2);
        canvas.drawLine(obs.topLeft, obs.bottomRight, Paint()..color=const Color(0xFF00FFCC)..strokeWidth=1);
    }
    for (int i = 0; i < engine.targets.length; i++) {
        ...
        canvas.drawCircle(target, 15, Paint()..color=Colors.purpleAccent);
        canvas.restore();
    }
    if (engine.exitGate != null) {
        canvas.drawCircle(engine.exitGate!, 45, Paint()..color=Colors.cyanAccent..style=PaintingStyle.stroke..strokeWidth=8);
    }
  ...
  @override bool shouldRepaint(covariant GamePainterA61 old) => true;
}
