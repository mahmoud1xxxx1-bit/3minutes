...
class GamePainterA92 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for(int i=0; i<40; i++) {
        ...
        canvas.drawLine(p1, p2, Paint()..color=const Color(0xFF39FF14).withOpacity(0.3)..strokeWidth=3);
        canvas.drawCircle(p1, 4, Paint()..color=const Color(0xFFFFD700).withOpacity(0.5));
    }
