...
class GamePainterA95 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint circlePaint = Paint()..color=const Color(0xFF9370DB).withOpacity(0.3)..style=PaintingStyle.stroke..strokeWidth=2;
    ...
    for (int i = 0; i < engine.obstacles.length; i++) {
        ...
        canvas.drawCircle(Offset(obs.left + 15, obs.top + 15), 8, Paint()..color=const Color(0xFF32CD32).withOpacity(0.8));
        canvas.drawCircle(Offset(obs.left + 15, obs.top + 15), 4, Paint()..color=Colors.white.withOpacity(0.5));
    }
