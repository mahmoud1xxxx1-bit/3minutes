...
class _NinjaSliceGameState extends State<NinjaSliceGame> with SingleTickerProviderStateMixin {
  ...
  void _spawnWave(Size size) {
    int numItems = 1 + _rnd.nextInt(2 + difficultyMultiplier.toInt().clamp(1, 4)); 
    for (int i = 0; i < numItems; i++) {
      ...
      // Toss higher as difficulty increases
      ...
      // Bomb probability scales with difficulty
      double bombChance = 0.10 + (difficultyMultiplier * 0.05);
      
      if (_rnd.nextDouble() < bombChance.clamp(0.0, 0.35)) {
