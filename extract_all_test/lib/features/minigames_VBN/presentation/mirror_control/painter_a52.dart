...
class GamePainterA52 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for(int i = 0; i < 40; i++) {
      ...
      canvas.drawLine(Offset(px, py), Offset(px - 10, py + 20), Paint()..color=Colors.white.withOpacity(0.4)..strokeWidth=1.5);
    }
    ...
    if (engine.exitGate != null) {
        canvas.drawCircle(engine.exitGate!, 45, Paint()..color=Colors.lightGreenAccent.withOpacity(0.5)..maskFilter=const MaskFilter.blur(BlurStyle.normal, 3));
