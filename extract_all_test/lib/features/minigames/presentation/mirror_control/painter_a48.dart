...
class GamePainterA48 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 20; i++) {
      ...
      canvas.drawCircle(Offset(px, py), 3, Paint()..color=Colors.lightBlueAccent.withOpacity(0.6));
    }
    ...
    for (int i = 0; i < engine.targets.length; i++) {
      ...
      if (isNext) {
          ...
          canvas.drawCircle(Offset.zero, tr*2, Paint()..shader = ui.Gradient.radial(Offset.zero, tr*2, [Colors.red.withOpacity(0.5), Colors.transparent]));
      } else {
          // Regular dull coin
